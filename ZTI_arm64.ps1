...
$OSActivation = 'Retail'
$OSLanguage = 'de-de'
$GroupTag = 'AutopilotKioskDeployment'
...
$oa3tool = 'https://raw.githubusercontent.com/4iotgmbh/AutoPilotResources/main/oa3tool_arm64.exe'
$pcpksp = 'https://raw.githubusercontent.com/4iotgmbh/AutoPilotResources/main/PCPKsp_arm64.dll'
